...
public:
  ...
  RAstarPlannerROS ();
  RAstarPlannerROS(std::string name, costmap_2d::Costmap2DROS* global_costmap); //costmap_ros);
  
  ros::NodeHandle ROSNodeHandle;
  
  /** overriden classes from interface nav_core::BaseGlobalPlanner **/
  void initialize(std::string name, costmap_2d::Costmap2DROS* global_costmap); //costmap_ros);
  ...
  float computePenalty(float h1, float h2, float moveCost, bool b);
